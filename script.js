...
function labelPosition(a) {
  ...
  $("."+ a +"ValueMax").html('<span class = "'+ a +'ValueMax" style= "margin-left:'+ (inputSize - 150) +'px">$4,000,000</span>');
  if (a == "default") {
  ...
  if (traveled * inputSize <= 100) {
    $("." + a + "ValueMin").addClass("fadeOut");
    $("." + a + "ValueMin").removeClass("fadeIn");
  };
  if (traveled * inputSize >= 100) {
    $("." + a + "ValueMin").addClass("fadeIn");
    $("." + a + "ValueMin").removeClass("fadeOut");
  };
  if (traveled * inputSize >= inputSize - 100) {
    $("." + a + "ValueMax").addClass("fadeOut");
    $("." + a + "ValueMax").removeClass("fadeIn");
  };
  if (traveled * inputSize <= inputSize - 100) {
    $("." + a + "ValueMax").addClass("fadeIn");
    $("." + a + "ValueMax").removeClass("fadeOut");
  }
  newPosition = Math.round((traveled * inputSize ) - ((93) * traveled));
  $("." + a + "PropertyPrice").html('<h4 class = "' + a + 'MobileLabel '+ a +'PropertyValue" style = "margin-left:' + newPosition + 'px">$2,100,000</h4>');
};
